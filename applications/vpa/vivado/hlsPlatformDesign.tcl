...
#
# line_detector.tcl: Tcl script for re-creating project 'line_detector'
#
# Generated by Vivado on Wed Feb 18 10:22:03 CET 2026
...
#
# 1. This project restoration tcl script (line_detector.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/home/marco/Scrivania/borsa/kv260/vivado_projects/RAW_artifact_original/vivado/line_detector/line_detector.srcs/sim_1/imports/simulation_sources/zynq_tb.v"
#    "/home/marco/Scrivania/borsa/kv260/vivado_projects/RAW_artifact_original/vivado/line_detector/line_detector.srcs/sim_1/imports/simulation_sources/tb_behav.wcfg"
#    "/home/marco/Scrivania/borsa/kv260/vivado_projects/RAW_artifact_original/vivado/line_detector/line_detector.srcs/sim_1/imports/simulation_sources/input.txt"
#    "/home/marco/Scrivania/borsa/kv260/vivado_projects/RAW_artifact_original/vivado/line_detector/line_detector.srcs/sim_1/imports/simulation_sources/input32.txt"
#    "/home/marco/Scrivania/borsa/kv260/vivado_projects/RAW_artifact_original/vivado/line_detector/line_detector.srcs/utils_1/imports/synth_1/line_detector_bd_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/sources/simulation_sources/zynq_tb.v"]"\
 "[file normalize "$origin_dir/sources/simulation_sources/tb_behav.wcfg"]"\
 "[file normalize "$origin_dir/sources/simulation_sources/input.txt"]"\
 "[file normalize "$origin_dir/sources/simulation_sources/input32.txt"]"\
  "[file normalize "$origin_dir/sources/synthesis_sources/line_detector_bd_wrapper.dcp"]"\
  ]
  foreach ifile $files {
  ...
  set paths [list \
 "[file normalize "$origin_dir/../../../../[file normalize "$origin_dir/../vitis_hls/prj_VPA_IP/solution1/impl/ip"]"]"\
 "[file normalize "$origin_dir/../../../../[file normalize "$origin_dir/../vitis_hls/prj_VPA_IP/solution1/impl/ip"]"]"\
  ]
  foreach ipath $paths {
...
set script_file "line_detector.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../line_detector"]"
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/../vitis_hls/prj_VPA_IP/solution1/impl/ip"]" $obj
...
set_property -name "top" -value "line_detector_bd_wrapper" -objects $obj
...
set file "simulation_sources/zynq_tb.v"
...
set file "simulation_sources/tb_behav.wcfg"
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
set_property -name "library" -value "xil_defaultlib" -objects $file_obj
...
set file "simulation_sources/input.txt"
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
set_property -name "library" -value "xil_defaultlib" -objects $file_obj
...
set file "simulation_sources/input32.txt"
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
set_property -name "library" -value "xil_defaultlib" -objects $file_obj
...
set_property -name "xsim.simulate.runtime" -value "500us" -objects $obj
...
set file "synthesis_sources/line_detector_bd_wrapper.dcp"
...
# Proc to create BD line_detector_bd
proc cr_bd_line_detector_bd { parentCell } {
  ...
  # Create instance: VPA_IP_0, and set properties
  ...
  # Create instance: rst_ps8_0_229M, and set properties
...
UART 1#UART 1#I2C 0#I2C 0#I2C 1#I2C 1#UART 0#UART 0###################PMU GPI\
0#PMU GPI 1#PMU GPI 2#PMU GPI 3#PMU GPI 4#PMU GPI 5#PMU GPO 0#PMU GPO 1#PMU GPO\
2#PMU GPO 3#PMU GPO 4#PMU GPO 5###########################Gem 3#Gem 3#Gem 3#Gem\
3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3##} \
   CONFIG.PSU_MIO_TREE_SIGNALS {\
txd#rxd#scl_out#sda_out#scl_out#sda_out#rxd#txd###################gpi[0]#gpi[1]#gpi[2]#gpi[3]#gpi[4]#gpi[5]#gpo[0]#gpo[1]#gpo[2]#gpo[3]#gpo[4]#gpo[5]###########################rgmii_tx_clk#rgmii_txd[0]#rgmii_txd[1]#rgmii_txd[2]#rgmii_txd[3]#rgmii_tx_ctl#rgmii_rx_clk#rgmii_rxd[0]#rgmii_rxd[1]#rgmii_rxd[2]#rgmii_rxd[3]#rgmii_rx_ctl##} \
   ...
   CONFIG.PSU__CRF_APB__TOPSW_MAIN_CTRL__ACT_FREQMHZ {399.960052} \
   ...
   CONFIG.PSU__CRL_APB__CAN0_REF_CTRL__ACT_FREQMHZ {99.990005} \
   ...
   CONFIG.PSU__CRL_APB__GEM_TSU_REF_CTRL__ACT_FREQMHZ {249.975006} \
   ...
   CONFIG.PSU__CRL_APB__PL0_REF_CTRL__ACT_FREQMHZ {229.977005} \
   ...
   CONFIG.PSU__CRL_APB__RPLL_CTRL__FBDIV {69} \
   CONFIG.PSU__CRL_APB__RPLL_CTRL__FRACDATA {0.000000} \
   CONFIG.PSU__CRL_APB__RPLL_CTRL__SRCSEL {PSS_REF_CLK} \
   CONFIG.PSU__CRL_APB__RPLL_FRAC_CFG__ENABLED {0} \
   CONFIG.PSU__CRL_APB__RPLL_TO_FPD_CTRL__DIVISOR0 {3} \
   CONFIG.PSU__CRL_APB__SDIO0_REF_CTRL__ACT_FREQMHZ {199.980011} \
   ...
   CONFIG.PSU__CRL_APB__USB0_BUS_REF_CTRL__ACT_FREQMHZ {249.975006} \
...
Port;FD4A0000;FD4AFFFF;0|FPD;DPDMA;FD4C0000;FD4CFFFF;0|FPD;DDR_XMPU5_CFG;FD050000;FD05FFFF;1|FPD;DDR_XMPU4_CFG;FD040000;FD04FFFF;1|FPD;DDR_XMPU3_CFG;FD030000;FD03FFFF;1|FPD;DDR_XMPU2_CFG;FD020000;FD02FFFF;1|FPD;DDR_XMPU1_CFG;FD010000;FD01FFFF;1|FPD;DDR_XMPU0_CFG;FD000000;FD00FFFF;1|FPD;DDR_QOS_CTRL;FD090000;FD09FFFF;1|FPD;DDR_PHY;FD080000;FD08FFFF;1|DDR;DDR_LOW;0;7FFFFFFF;1|DDR;DDR_HIGH;800000000;800000000;0|FPD;DDDR_CTRL;FD070000;FD070FFF;1|LPD;Coresight;FE800000;FEFFFFFF;1|LPD;CSU_DMA;FFC80000;FFC9FFFF;1|LPD;CSU;FFCA0000;FFCAFFFF;1|LPD;CRL_APB;FF5E0000;FF85FFFF;1|FPD;CRF_APB;FD1A0000;FD2DFFFF;1|FPD;CCI_REG;FD5E0000;FD5EFFFF;1|LPD;CAN1;FF070000;FF07FFFF;0|LPD;CAN0;FF060000;FF06FFFF;0|FPD;APU;FD5C0000;FD5CFFFF;1|LPD;APM_INTC_IOU;FFA20000;FFA2FFFF;1|LPD;APM_FPD_LPD;FFA30000;FFA3FFFF;1|FPD;APM_5;FD490000;FD49FFFF;1|FPD;APM_0;FD0B0000;FD0BFFFF;1|LPD;APM2;FFA10000;FFA1FFFF;1|LPD;APM1;FFA00000;FFA0FFFF;1|LPD;AMS;FFA50000;FFA5FFFF;1|FPD;AFI_5;FD3B0000;FD3BFFFF;1|FPD;AFI_4;FD3A0000;FD3AFFFF;1|FPD;AFI_3;FD390000;FD39FFFF;1|FPD;AFI_2;FD380000;FD38FFFF;1|FPD;AFI_1;FD370000;FD37FFFF;1|FPD;AFI_0;FD360000;FD36FFFF;1|LPD;AFIFM6;FF9B0000;FF9BFFFF;1|FPD;ACPU_GIC;F9010000;F907FFFF;1} \
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins VPA_IP_0/im_axis_in] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S]
  ...
  connect_bd_net -net rst_ps8_0_229M_peripheral_aresetn [get_bd_pins VPA_IP_0/ap_rst_n] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_dma_1/axi_resetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins rst_ps8_0_229M/peripheral_aresetn] [get_bd_pins smartconnect_0/aresetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins VPA_IP_0/ap_clk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_dma_1/m_axi_s2mm_aclk] [get_bd_pins axi_dma_1/s_axi_lite_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins rst_ps8_0_229M/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins rst_ps8_0_229M/ext_reset_in] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"0.340162",
   "Default View_TopLeft":"-679,-168",
   "ExpandedHierarchyInLayout":"",
   "PinnedBlocks":"",
   "guistr":"# # String gsaved with Nlview 7.0r4  2019-12-20 bk=1.5203 VDI=41 GEI=36 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 4 -x 1480 -y 290 -defaultsOSRD
preplace inst axi_interconnect_0 -pg 1 -lvl 5 -x 1970 -y 380 -defaultsOSRD
preplace inst axi_dma_0 -pg 1 -lvl 6 -x 2320 -y 400 -defaultsOSRD
preplace inst VPA_IP_0 -pg 1 -lvl 7 -x 2690 -y 410 -defaultsOSRD
preplace inst axi_dma_1 -pg 1 -lvl 2 -x 600 -y 280 -defaultsOSRD
preplace inst smartconnect_0 -pg 1 -lvl 3 -x 980 -y 90 -defaultsOSRD
preplace inst rst_ps8_0_229M -pg 1 -lvl 1 -x 210 -y 290 -defaultsOSRD
preplace netloc rst_ps8_0_229M_peripheral_aresetn 1 1 6 380 140 810 210 1150J 170 1790 210 2120 490 2480J
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 0 7 30 190 390 150 790 230 1110 400 1800 550 2130 310 2490
preplace netloc zynq_ultra_ps_e_0_pl_resetn0 1 0 5 20 160 NJ 160 780J 220 1130J 140 1770
preplace netloc VPA_IP_0_current_pos 1 1 7 400 170 800J 180 1110J 150 NJ 150 NJ 150 NJ 150 2860
preplace netloc axi_dma_0_M_AXIS_MM2S 1 6 1 N 390
preplace netloc axi_dma_0_M_AXI_MM2S 1 2 5 820 190 1120J 160 NJ 160 NJ 160 2480
preplace netloc axi_dma_1_M_AXI_S2MM 1 2 1 760 80n
preplace netloc axi_interconnect_0_M00_AXI 1 5 1 N 370
preplace netloc axi_interconnect_0_M01_AXI 1 1 5 410 180 770J 200 1160J 180 NJ 180 2110
preplace netloc smartconnect_0_M00_AXI 1 3 1 1140 90n
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM0_FPD 1 4 1 1800 240n
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM1_FPD 1 4 1 1780 260n
levelinfo -pg 1 0 210 600 980 1480 1970 2320 2690 2890
pagesize -pg 1 -db -bbox -sgen 0 0 2890 560
"
}
...
# End of cr_bd_line_detector_bd()
cr_bd_line_detector_bd ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files line_detector_bd.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "0" [get_files line_detector_bd.bd ] 
set_property IS_ENABLED "1" [get_files line_detector_bd.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files line_detector_bd.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files line_detector_bd.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files line_detector_bd.bd ] 
set_property PFM_NAME "" [get_files line_detector_bd.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files line_detector_bd.bd ] 
set_property SYNTH_CHECKPOINT_MODE "None" [get_files line_detector_bd.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files line_detector_bd.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files line_detector_bd.bd ] 
set_property USED_IN_SIMULATION "1" [get_files line_detector_bd.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files line_detector_bd.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse line_detector_bd.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/RAW_artifact_original/vivado/line_detector/line_detector.gen/sources_1/bd/line_detector_bd/hdl/line_detector_bd_wrapper.vhd" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse line_detector_bd.bd] -top]
...
set_property -name "incremental_checkpoint" -value "$proj_dir/line_detector.srcs/utils_1/imports/synthesis_sources/line_detector_bd_wrapper.dcp" -objects $obj
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/line_detector.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/line_detector.srcs/utils_1/imports/impl_1" -objects $obj
...
set_property -name "steps.phys_opt_design.args.more options" -value "-hold_fix" -objects $obj
